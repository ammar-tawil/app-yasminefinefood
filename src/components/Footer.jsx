    ...
    <footer className="footer">
      <div className="container">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo" aria-label="Yasmine Fine Food Home">
              ...
              <div className="footer__logo-text">
                <span className="footer__logo-name">Yasmine<span className="trademark">®</span></span>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">&copy; {new Date().getFullYear()} Yasmine<span className="trademark">®</span> Fine Food. All rights reserved. | ABN: 82 162 348 423</p>
