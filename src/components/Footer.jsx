    ...
    <footer className="footer">
      <div className="container">
            ...
            <Link to="/" className="footer__logo">
              <div className="footer__logo-icon">
                <svg width="32" height="32" viewBox="0 0 40 40" fill="none">
                  <circle cx="20" cy="20" r="20" fill="#4A5D23"/>
                  <path d="M20 8C20 8 12 14 12 22C12 26 15.6 30 20 30C24.4 30 28 26 28 22C28 14 20 8 20 8Z" fill="#F9F8F6" opacity="0.9"/>
                  <path d="M20 12C20 12 16 16.5 16 21C16 24 17.8 26.5 20 26.5C22.2 26.5 24 24 24 21C24 16.5 20 12 20 12Z" fill="#4A5D23" opacity="0.6"/>
                </svg>
              </div>
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} Yasmine Fine Food. All rights reserved. | ABN: [Your ABN Here]</p>
