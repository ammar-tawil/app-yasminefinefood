        ...
        <div className="about__grid">
          ...
          <div className="about__content">
            ...
            <p className="about__text reveal" style={{ animationDelay: '0.4s' }}>
              Yasmine<span className="trademark">®</span> Fine Food is a Sydney-based B2B food sourcing and distribution company
            ...
            <p className="about__text reveal" style={{ animationDelay: '0.6s' }}>
            ...
            <p className="about__text reveal" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="about__stats reveal" style={{ animationDelay: '1.0s' }}>
